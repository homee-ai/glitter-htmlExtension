                                                    ...
                                                    widget.data.dataList.forEach((data) => {
                                                        ...
                                                        returnHtml += `
                                                            <div class="d-flex flex-column" style="padding:40px 16px 24px 24px;">
                                                                <div class="d-flex rightCategoryTitle" style="margin-bottom: ${(_a = data.titleDistance) !== null && _a !== void 0 ? _a : 0}px" id="${title}">${title}</div>
                    ...
                    editor: () => {
                        return `${gvc.map(widget.data.dataList.map((dd, index) => {
                            ...
                            <div class="d-flex flex-column my-3 alert alert-dark">
                                ...
                                gvc: gvc,
                                title: `標題和下方元素的距離`,
                                default: (_a = dd.titleDistance) !== null && _a !== void 0 ? _a : 0,
                                placeHolder: (_b = dd.titleDistance) !== null && _b !== void 0 ? _b : 0,
                                callback: (text) => {
                                    widget.data.dataList[index].titleDistance = text;
                                    widget.refreshAll();
                                }
                            })}                             
                                ${(() => {
