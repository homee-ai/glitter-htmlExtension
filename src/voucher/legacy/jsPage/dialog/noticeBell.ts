...
import {OrderNotice, OrderNoticeStruct} from "../../api/orderNotice.js";
    ...
    return {
        onCreateView: () => {
            return gvc.bindView({
                ...
                view: () => {
                    return `
                    <div class="w-100 d-flex justify-content-end" style="padding-top: ${top}px;padding-right: 45px;background: transparent" onclick=" ${
                        gvc.event(() => {
                    ...
                    <div class="top-row" style="height: calc(100vh - ${top}px)">
                        ...
                        ${gvc.bindView({
                            ...
                            view : ()=>{
                                ...
                                `)
                                vm.model.orderNotice.forEach((orderDetail:OrderNoticeStruct)=>{
