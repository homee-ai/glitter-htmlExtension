    ...
    return {
        ...
        <main style="overflow-x: hidden;">                                   
            ...
            ${gvc.bindView({
                        bind: "firstAddress",
                        view: () => {
                            if (vm.loading && (firstAddressData === null || firstAddressData === void 0 ? void 0 : firstAddressData.address)) {
...
const formatTimeByAPM = (time, apm) => {
...
const formatTimeByHMS = (time, symbol) => {
    let result = '';
    if (time === undefined) {
