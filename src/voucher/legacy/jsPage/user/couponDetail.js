...
import { LegacyPage } from "../../interface.js";
init((gvc, glitter, gBundle) => {
    gvc.addStyle(`
        @font-face {
            font-family: 'Noto Sans TC';
            src: url(${LegacyPage.getLink("assets/Font/NotoSansTC-Bold.otf")});
            font-weight: bold;
        }

        @font-face {
            font-family: 'Noto Sans TC';
            src: url(${LegacyPage.getLink("assets/Font/NotoSansTC-Regular.otf")};
            font-weight: normal;
        }
    ...
    const data = gBundle.data;
    return {
        onCreateView: () => {
            if (data === undefined) {
                glitter.changePage(LegacyPage.getLink('jsPage/user/couponTotal.js'), 'couponTotal', true, {});
                return '';
            }
            else {
                                ...
                                context: (() => {
                                    ...
                                    switch (data.config.applicability_product) {
                                        ...
                                        case 'categories':
                                            ...
                                            break;
                                        case 'products':
                                            data.config.app_products.map((a, i) => {
                ...
                return gvc.bindView({
                    ...
                    view: () => {
                        return `
                            ...
                            leftIcon: ` <img
                                        class=""
                                        src=${LegacyPage.getLink("img/sample/idea/left-arrow.svg")}
                            ...
                            rightIcon: `
                                        <img
                                            class=""
                                            src=${LegacyPage.getLink("img/customerService.png")}
