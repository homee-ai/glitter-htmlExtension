            ...
            render:(gvc, widget, setting, hoverID) => {
                ...
                return {
                    view: ()=>{
                        return gvc.map([
                            drawNav("",
                                `<img class="" src="${widget.data.nav.leftIcon}" style="width: 24px;height: 24px;" alt="" onclick="${gvc.event(() => {
                                })}">`,
                    ...
                    view: ()=>{return `                        
                        ...
                        ${gvc.bindView({
                            ...
                            view : ()=>{
                                ...
                                `)
                                return gvc.map(widget.data.sizeSelect.map((sizeType:any , index:number)=>{
                                    return `
                                        ${gvc.bindView({
                                            bind : `type${index}`,
                                            view : ()=>{
