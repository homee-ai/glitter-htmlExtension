    ...
    return {
       ...
       ${gvc.bindView({
                        ...
                        <div class="productQTYRow d-flex align-items-center justify-content-between " style="">
                            ...
                            view: () => {
                                return `
                                        <input class="border-0 text-center" style="width: 45px;"  value="${widget.data.qty}" onchange="${gvc.event((e: HTMLInputElement) => {
                            ...
                            view: () => {
                                ...
                                <div class="footer d-flex align-items-center " style="padding:12px 20px ${bottomInset}px;background: #FFFFFF;box-shadow: 0px -5px 15px rgba(0, 0, 0, 0.05);">
                                    ...
                                    <div class="footerBTN ms-auto d-flex  ${selectSku.t3dModel ? ``:`d-none`}">
                                        ...
                                        <div class="footerBTNRight d-flex align-items-center justify-content-center" onclick="${
                                    gvc.event((e)=>{
                                        const dialog=new Dialog(gvc)
                                        Checkout.addToCart({
                                            category:"購物車",
